...
- POST /courses/{courseId}/lessons — cria uma aula em um curso
- GET /courses/{courseId}/lessons — lista aulas de um curso

🔹 Aulas e Estudantes (N:N)
- POST /students — cria um estudante
- POST /lessons/{lessonId}/students/{studentId} — inscreve estudante em uma aula
- GET /lessons/{lessonId}/students — lista estudantes de uma aula
